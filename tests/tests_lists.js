...
test('List - GET /lists/:id', function () {
    ...
    tasks[0].push(task_create({title: "Completed Task", list: lists[0]._id, completed: true}));
    deepEqual(list_get_filter(lists[0]._id, "completed=1"), {list: lists[0], tasks: [tasks[0][8].task]},
